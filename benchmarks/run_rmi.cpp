...
rmi::SearchType RMI_SEARCH_TYPE = rmi::SearchType::NONE;

//Function Headers
void praser(int argc, char** argv);
void run_rmi(vector<uint64_t> & data, rmi::RMI<uint64_t> & rmi);
...
int main(int argc, char** argv)
{
    ...
    rmi::RMI<uint64_t> rmi(data,RMI_ROOT_TYPE,RMI_LEAF_TYPE,NUM_SEGMENT,RMI_SEARCH_TYPE);
    run_rmi(data, rmi);
...
void praser(int argc, char** argv)
{
    ASSERT_MESSAGE(argc == 4, "Usage: ./run_rmi <rmi_root_type:int> <rmi_leaf_type:int> <rmi_search_type:int>");
    ...
    switch (atoi(argv[1]))
    {
        ...
        case 3: //CUBIC_SPLINE
            ...
            break;
        default:
            ASSERT_MESSAGE(false, "Invalid RMI Root Type: CONSTANT (0), LINEAR_SPLINE (1), LINEAR_REGRESSION (2), or CUBIC_SPLINE (3)");
            break;
    }
    ...
    switch (atoi(argv[2]))
    {
        ...
        case 3: //CUBIC_SPLINE
            ...
            break;
        default:
            ASSERT_MESSAGE(false, "Invalid RMI Leaf Type: CONSTANT (0), LINEAR_SPLINE (1), LINEAR_REGRESSION (2), or CUBIC_SPLINE (3)");
            break;
    }
    ...
    {
        case 0: //BINARY_MAX
            RMI_SEARCH_TYPE = rmi::SearchType::BINARY_MAX;
            cout << ";SearchType=BINARY_MAX";
            break;
        case 1: //BINARY_MAX_SEG
            RMI_SEARCH_TYPE = rmi::SearchType::BINARY_MAX_SEG;
            cout << ";SearchType=BINARY_MAX_SEG";
            break;
        case 2: //BINARY_ENTIRE
            RMI_SEARCH_TYPE = rmi::SearchType::BINARY_ENTIRE;
            cout << ";SearchType=BINARY_ENTIRE";
            break;
        case 3: //EXPONENTIAL
            RMI_SEARCH_TYPE = rmi::SearchType::EXPONENTIAL;
            cout << ";SearchType=EXPONENTIAL";
            break;
        case 4: //LINEAR
            RMI_SEARCH_TYPE = rmi::SearchType::LINEAR;
            cout << ";SearchType=LINEAR";
            break;
        default:
            ASSERT_MESSAGE(false, "Invalid RMI Search Type: BINARY_MAX (0), BINARY_MAX_SEG (1), BINARY_ENTIRE (2), EXPONENTIAL (3), or LINEAR (4");
            break;
    }
    ASSERT_MESSAGE(RMI_SEARCH_TYPE != rmi::SearchType::NONE, "Invalid RMI Search Type: NONE");
}
...
void run_rmi(vector<uint64_t> & data, rmi::RMI<uint64_t> & rmi)
{
    ...
    //Memory (bytes)
    uint64_t memoryUsage = rmi.size_of();

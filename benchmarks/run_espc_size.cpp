...
//RMI Configuration (Confirguration in src/helper_functions/helper_rmi.hpp)
rmi::ModelType RMI_ROOT_TYPE = rmi::ModelType::NONE;
rmi::ModelType RMI_LEAF_TYPE = rmi::ModelType::NONE;
rmi::SearchType RMI_ROOT_SEARCH_TYPE = rmi::SearchType::NONE;
rmi::SearchType RMI_LEAF_SEARCH_TYPE = rmi::SearchType::NONE;

//Function Headers
void praser(int argc, char** argv);
void run_rmi_equal_split(vector<uint64_t> & data, rmi::EqualSplit<uint64_t> & rmiEqualSplit);
...
int main(int argc, char** argv)
{
    ...
    rmi::EqualSplit<uint64_t> rmiEqualSplit(data,RMI_ROOT_TYPE,RMI_LEAF_TYPE,NUM_SEGMENT,
                                            RMI_ROOT_SEARCH_TYPE, RMI_LEAF_SEARCH_TYPE);
    run_rmi_equal_split(data, rmiEqualSplit);
...
void praser(int argc, char** argv)
{
    ASSERT_MESSAGE(argc == 5, "Usage: ./run_rmi <rmi_root_type:int> <rmi_leaf_type:int> <rmi_root_search_type:int> <rmi_leaf_search_type:int>");
    ...
    {
        case 0: //CONSTANT
            RMI_ROOT_TYPE = rmi::ModelType::CONSTANT;
            cout << ";RootType=CONSTANT";
            break;
        case 1: //LINEAR_SPLINE
            RMI_ROOT_TYPE = rmi::ModelType::LINEAR_SPLINE;
            cout << ";RootType=LINEAR_SPLINE";
            break;
        case 2: //LINEAR_REGRESSION
            RMI_ROOT_TYPE = rmi::ModelType::LINEAR_REGRESSION;
            cout << ";RootType=LINEAR_REGRESSION";
            break;
        case 3: //CUBIC_SPLINE
            RMI_ROOT_TYPE = rmi::ModelType::CUBIC_SPLINE;
            cout << ";RootType=CUBIC_SPLINE";
            break;
        default:
            ASSERT_MESSAGE(false, "Invalid RMIEqualSplit Root Type: CONSTANT (0), LINEAR_SPLINE (1), LINEAR_REGRESSION (2), or CUBIC_SPLINE (3)");
            break;
    }
    ASSERT_MESSAGE(RMI_ROOT_TYPE != rmi::ModelType::NONE, "Invalid RMI Root Type: NONE");

    //Leaf Type
    switch (atoi(argv[2]))
    {
        case 0: //CONSTANT
            RMI_LEAF_TYPE = rmi::ModelType::CONSTANT;
            cout << ";LeafType=CONSTANT";
            break;
        case 1: //LINEAR_SPLINE
            RMI_LEAF_TYPE = rmi::ModelType::LINEAR_SPLINE;
            cout << ";LeafType=LINEAR_SPLINE";
            break;
        case 2: //LINEAR_REGRESSION
            RMI_LEAF_TYPE = rmi::ModelType::LINEAR_REGRESSION;
            cout << ";LeafType=LINEAR_REGRESSION";
            break;
        case 3: //CUBIC_SPLINE
            RMI_LEAF_TYPE = rmi::ModelType::CUBIC_SPLINE;
            cout << ";LeafType=CUBIC_SPLINE";
            break;
        default:
            ASSERT_MESSAGE(false, "Invalid RMIEqualSplit Leaf Type: CONSTANT (0), LINEAR_SPLINE (1), LINEAR_REGRESSION (2), or CUBIC_SPLINE (3)");
            break;
    }
    ASSERT_MESSAGE(RMI_LEAF_TYPE != rmi::ModelType::NONE, "Invalid RMI Leaf Type: NONE");

    //Root Search Type
    switch (atoi(argv[3]))
    {
        case 0: //BINARY_MAX
            RMI_ROOT_SEARCH_TYPE = rmi::SearchType::BINARY_MAX;
            cout << ";SearchType=BINARY_MAX";
            break;
        case 1: //BINARY_MAX_SEG
            RMI_ROOT_SEARCH_TYPE = rmi::SearchType::BINARY_MAX_SEG;
            cout << ";SearchType=BINARY_MAX_SEG";
            break;
        case 2: //BINARY_ENTIRE
            RMI_ROOT_SEARCH_TYPE = rmi::SearchType::BINARY_ENTIRE;
            cout << ";SearchType=BINARY_ENTIRE";
            break;
        case 3: //EXPONENTIAL
            RMI_ROOT_SEARCH_TYPE = rmi::SearchType::EXPONENTIAL;
            cout << ";SearchType=EXPONENTIAL";
            break;
        case 4: //LINEAR
            RMI_ROOT_SEARCH_TYPE = rmi::SearchType::LINEAR;
            cout << ";SearchType=LINEAR";
            break;
        default:
            ASSERT_MESSAGE(false, "Invalid RMIEqualSplit Root Search Type: BINARY_MAX (0), BINARY_MAX_SEG (1), BINARY_ENTIRE (2), EXPONENTIAL (3), or LINEAR (4");
            break;
    }
    ASSERT_MESSAGE(RMI_ROOT_SEARCH_TYPE != rmi::SearchType::NONE, "Invalid RMIEqualSplit Root Search Type: NONE");

    //Leaf Search Type
    switch (atoi(argv[4]))
    {
        case 0: //BINARY_MAX
            RMI_LEAF_SEARCH_TYPE = rmi::SearchType::BINARY_MAX;
            cout << ";SearchType=BINARY_MAX";
            break;
        case 1: //BINARY_MAX_SEG
            RMI_LEAF_SEARCH_TYPE = rmi::SearchType::BINARY_MAX_SEG;
            cout << ";SearchType=BINARY_MAX_SEG";
            break;
        case 2: //BINARY_ENTIRE
            RMI_LEAF_SEARCH_TYPE = rmi::SearchType::BINARY_ENTIRE;
            cout << ";SearchType=BINARY_ENTIRE";
            break;
        case 3: //EXPONENTIAL
            RMI_LEAF_SEARCH_TYPE = rmi::SearchType::EXPONENTIAL;
            cout << ";SearchType=EXPONENTIAL";
            break;
        case 4: //LINEAR
            RMI_LEAF_SEARCH_TYPE = rmi::SearchType::LINEAR;
            cout << ";SearchType=LINEAR";
            break;
        default:
            ASSERT_MESSAGE(false, "Invalid RMIEqualSplit Leaf Search Type: BINARY_MAX (0), BINARY_MAX_SEG (1), BINARY_ENTIRE (2), EXPONENTIAL (3), or LINEAR (4");
            break;
    }
    ASSERT_MESSAGE(RMI_LEAF_SEARCH_TYPE != rmi::SearchType::NONE, "Invalid RMIEqualSplit Leaf Search Type: NONE");
}
...
void run_rmi_equal_split(vector<uint64_t> & data, rmi::EqualSplit<uint64_t> & rmiEqualSplit)
{
    ...
    //Memory (bytes)
    uint64_t memoryUsage = rmiEqualSplit.size_of();
